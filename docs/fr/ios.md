...
Une liaison distincte prend en charge l’import Darwin exact String → NSString `_$sSS10FoundationE19_bridgeToObjectiveCSo8NSStringCyF` sur arm64 et x86_64. Elle préserve les deux mots de String, le résultat objet possédé et Clang `swiftcall` ; la liaison nécessite Swift Foundation et Swift Core. Le pont inverse et les autres signatures Swift restent non pris en charge.
