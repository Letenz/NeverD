...
Un enlace separado admite la importación Darwin exacta String → NSString `_$sSS10FoundationE19_bridgeToObjectiveCSo8NSStringCyF` en arm64 y x86_64. Conserva ambas palabras de String, el objeto devuelto con propiedad y Clang `swiftcall`; el enlace requiere Swift Foundation y Swift Core. El puente inverso y otras firmas Swift siguen sin admitirse.
