...
Las funciones nativas locales también pueden exponer contextos enteros de solo lectura en registros preservados. El análisis existente de entradas observables debe confirmar su uso, y el LowIR completo debe demostrar una lectura de ancho completo sin escrituras en registros preservados ajenos al marco. Los llamadores y las definiciones regenerados usan los mismos parámetros físicos explícitos. Esto no deduce un prototipo C o Swift externo; las salidas ocultas de registros, las pruebas ausentes y las dependencias incompletas siguen sin admitirse.
