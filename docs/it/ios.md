...
Un’associazione separata supporta l’importazione Darwin esatta String → NSString `_$sSS10FoundationE19_bridgeToObjectiveCSo8NSStringCyF` su arm64 e x86_64. Conserva entrambe le parole di String, l’oggetto restituito con proprietà e Clang `swiftcall`; il collegamento richiede Swift Foundation e Swift Core. Il bridging inverso e le altre firme Swift restano non supportati.
