...
L’esportazione Objective-C associa anche un insieme fisso di importazioni del runtime Swift con ABI C ordinaria: conteggio dei riferimenti, riferimenti deboli nativi e a oggetti di tipo sconosciuto, metadati degli oggetti e inizio/fine del controllo degli accessi. Il C generato conserva le chiamate e richiede il runtime Swift al collegamento. Restano esclusi gli ingressi con registri specializzati, le convenzioni di chiamata Swift e i simboli Swift arbitrari; identità importate e posizioni scalari devono coincidere esattamente.
