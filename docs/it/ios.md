...
Le funzioni native locali possono anche esporre contesti interi di sola lettura nei registri preservati. L’analisi esistente degli ingressi osservabili deve confermarne l’uso e il LowIR completo deve dimostrare una lettura dell’intera larghezza senza scritture nei registri preservati esterni al frame. Chiamanti e definizioni rigenerati usano gli stessi parametri fisici espliciti. Non viene dedotto alcun prototipo C o Swift esterno; uscite nascoste nei registri, prove mancanti e dipendenze incomplete restano non supportate.
