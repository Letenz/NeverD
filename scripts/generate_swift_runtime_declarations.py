...
# {TypeMetadataPtrTy, SizeTy}. Metadata.h also requires SwiftCC for its two
# result carriers. Keep named layouts separate from scalar argument types.
...
def render(facts, digest):
    lines = ['// clang-format off',
             ...
             '// Metadata response layout: lib/IRGen/IRGenModule.cpp:295-298 and',
             '// include/swift/ABI/Metadata.h:99-113 at the same revision.',
